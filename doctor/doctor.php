...
<body>
  <div id="main-wrapper" class="doctor-wrapper animsition">
    ...
    <div class="doc-contents">
      <div class="c-topview appear up">
        <div class="c-topview__img item">
          <img class="view-sp" src="<?php echo get_template_directory_uri(); ?>/images/home/clinic__1@pc.jpg" alt="">
          <img class="view-pc" src="<?php echo get_template_directory_uri(); ?>/images/home/clinic__1@pc.jpg" alt="">
        </div>
      </div>
      <div class="c-container appear up">
        <h1 class="doc-title item">
          <p class="c-title">医師紹介</p>
          <p class="c-subtitle">DOCTOR PROFILE</p>
        </h1>
        <div class="doc-block item">
          <div class="doc-wrap">
            <figure class="doc-profile-img">
              <img src="<?php echo get_template_directory_uri(); ?>/images/home/staff__1@sp.jpg" alt="" />
            </figure>
            <div class="doc-desc">
              <h3 class="doc-name">
                <p class="doc-director">医院長</p>
                <p class="doc-name-ja">利部 翔太</p>
              </h3>
              <p class="c-txt-sm">
          ...
          <div class="career">
            <figure>
              <img src="<?php echo get_template_directory_uri(); ?>/images/home/clinic__1@sp.jpg" alt="" />
              <img src="<?php echo get_template_directory_uri(); ?>/images/home/medical__2@sp.jpg" alt="" />
            </figure>
            <div class="c-txt-sm">
              <h4>所属学会</h4>
              <p>日本耳鼻咽喉科学会</p>
              ...
              <dl>
                ...
                <dd>
                  <p>
                    北海道大学医学部卒業<br />名古屋市立大学病院耳鼻咽喉科にて研修
                  </p>
                </dd>
              </dl>
              <dl>
